...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Page.read_permission'
        db.add_column('wiki_page', 'read_permission', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Page.read_permission'
        db.delete_column('wiki_page', 'read_permission')
    ...
    models = {
        ...
        'wiki.page': {
            ...
            'read_permission': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '50', 'db_index': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'write_permission': ('django.db.models.fields.IntegerField', [], {'default': '0'})
        },
        'wiki.revision': {
